  ...
  return (
    <div className="col-md-12 p-0">
        ...
        <div className="container">
            <img className={styles.with_expert_img} src="../images/expert.jpg"  />
        </div>
        <div className="col-md-12 p-0 mt-5">
            <div className="row">
                <div className="col-md-6 text-left">
                    <div className="col-md-12 pl-5">
                    <h1>AN ALL-IN-ONE<br/> SERVICE APP</h1>
                    ...
                    <h1 className="mt-4">THE PROBLEM</h1>
            ...
            <div className={styles.background_grad_sec2}>
                <div className="container pb-5">
                    ...
                    <div className="col-md-6 text-left" >
                        ...
                        <img  src="../images/shape.png" className="img-fluid img_animate"  />
                        <img  src="../images/shape1.png" className="img-fluid img_animate1"  />
                        </div>
                    <img  src="../images/sit.png" className="img-fluid img_width_girl"  />
                    
                    </div>
                    <div className="col-md-6 text-left m-auto" >
                    <h1 className={styles.color_white}>SOLUTION</h1>
                    ...
                    <div className="row mt-5">
                        ...
                        <img  src="../images/xpert.png" className="img-fluid img_width_girl"  />
                        </div>
                        <div className="col-md-4 col-4">
                        <img  src="../images/google.png" className="img-fluid img_width_girl"  />
                        </div>
                        <div className="col-md-4 col-4">
                        <img  src="../images/apple.png" className="img-fluid img_width_girl"  />
                        </div>
                    </div>
                     </div>
                     </div>
